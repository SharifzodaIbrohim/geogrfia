/* Даъватнома print patch — load AFTER admin-students-reg if present */
(function(){
  ...
  function patchHtml(html){
    ...
    // force black IG QR from api if still present
  ...
  // Patch Blob constructor used by registerStudent / open card
  ...
  console.log("[davotnoma-print] compact 1-page + black IG patch installed");
})();
