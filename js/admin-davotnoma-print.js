/* Даватнома print patch — load AFTER admin-students-reg if present */
(function(){
  var CSS = "@page{size:A4;margin:5mm}"+ 
    ...
    ".head{padding:5px 10px 4px!important}.head h1{font-size:1.05rem!important;margin:3px 0 1px!important}"+ 
