...
(function () {
  ...
  function buildStudentCardHtml(st) {
    ...
    return "<!DOCTYPE html><html lang=\"tg\"><head><meta charset=\"utf-8\"/>" +
      ...
      "<div class=\"toolbar\"><button type=\"button\" onclick=\"window.print()\">🖨 Чоп / Save as PDF</button></div>" +
      "<article class=\"pass\">" +
      "<header class=\"head\"><div class=\"brand\">GEOGRAFIA.TJ</div>" +
  ...
  async function registerStudent(e) {
    ...
    try {
      ...
      if (msg) {
        msg.textContent = "ID: " + (s.id || "") + " · Даватнома кушода шуд";
  ...
  function bind() {
    ...
    if (form) { form.onsubmit = function (e) { e.preventDefault(); registerStudent(e); return false; }; }
    ...
    var clr = document.getElementById("btnClearPhoto");
    if (clr) clr.onclick = function (e) { e.preventDefault(); clearPhoto(); };
