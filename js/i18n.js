...
(() => {
  const DICT = {
    tg: {
      ...
      yes: 'Ҳа', no: 'Не', of: 'аз', questions: 'савол', question: 'Савол', questionLabel: 'Савол', passScore: 'Ҳад',
    ...
    ru: {
      ...
      yes: 'Да', no: 'Нет', of: 'из', questions: 'вопросов', question: 'Вопрос', questionLabel: 'Вопрос', passScore: 'Порог',
    ...
    en: {
      ...
      yes: 'Yes', no: 'No', of: 'of', questions: 'questions', question: 'Question', questionLabel: 'Question', passScore: 'Pass',
  ...
  function safeBoot() {
    try { bootI18n(); } catch (e) { console.error('[i18n]', e); }
  }
  try {
