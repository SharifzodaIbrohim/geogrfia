/**
 * Geografia full i18n
 * Languages: tg (Тоҷикӣ, default), ru, en
 * Storage: geografia_lang + geo_lang (legacy)
 * API: window.GeoI18n = { t, setLang, lang, apply, onLang, DICT }
 * Alias: window.t(key, params)
 */
(() => {
  const DICT = {
    tg: {
      ...
      leaderboardTitle: 'Рейтинг · Беҳтаринҳо',
      activityEmpty: 'Фаъолият ҳоло нест',
      olympEmpty: 'Фаъол нест',
      lbEmpty: 'Натиҷаҳо баъд аз супориш',
      resultsLog: 'results.log',
      live: 'live',
      olympiadActive: 'Олимпиада фаъол',
      quizAvailable: 'Викторина дастрас',
      now: 'ҳоло',
      noActivity: 'Фаъолият ҳоло нест',
      ...
      capital: 'Пойтахт',
      countryCount: 'кишвар',
      coursesTitle: 'Курсҳо · Китобҳо ва маводҳо',
      ...
      history: 'Таърих',
      startQuiz: 'Оғоз кардан',
      continueQuiz: 'Идома додан',
      noQuizzes: 'Ҳанӯз викторина нест.',
      studentLoginTitle: 'Воридшавии хонанда',
      studentLoginHint: 'Танҳо бо ID-е, ки админ додааст',
      studentIdLabel: 'ID-и шумо',
      studentIdPlaceholder: 'Рақами донишҷӯ',
      studentLoginBtn: 'Ворид шудан',
      activeOlympiads: 'Олимпиадаҳои фаъол',
      quizzesSection: 'Викторинаҳо',
      noActiveOlympiad: 'Ҳоло олимпиадаи фаъол нест.',
      noQuizzesStudent: 'Ҳоло викторина нест.',
      statusActive: 'Фаъол',
      statusUpcoming: 'Ба наздикӣ',
      statusFinished: 'Анҷомёфта',
      statusParticipated: 'Шумо иштирок кардаед',
      statusInProgress: 'Дар ҷараён',
      statusLocked: 'Қулфшуда',
      start: 'Оғоз',
      startExam: 'Оғоз кардан',
      continueExam: 'Идома додан',
      ...
      questionOf: 'Савол {n} аз {total}',
      questionXofY: 'Савол {n} / {total}',
      selectAnswer: 'Ҷавобро интихоб кунед',
      writeAnswer: 'Ҷавобро нависед',
      writeAnswerPlaceholder: 'Ҷавобро нависед...',
      matchingHint: 'Ҷуфтҳоро мувофиқ кунед',
      shortAnswer: 'Ҷавоби кӯтоҳ',
      textAnswer: 'Ҷавоби матнӣ',
      noQuestion: 'Савол нест',
      result: 'Натиҷа',
      score: 'Хол',
      percent: 'Фоиз',
      correct: 'Дуруст',
      incorrect: 'Нодуруст',
      passed: 'Шумо гузаштед',
      failed: 'Шумо нагузаштед',
      waiting: 'Интизор',
      backToList: 'Бозгашт ба рӯйхат',
      attemptUsed: 'Шумо аллакай ин олимпиадаро супоридаед',
      secondAttemptDenied: 'Кӯшиши дуюм иҷозат дода намешавад',
      timeUp: 'Вақт тамом шуд',
      submitConfirm: 'Оё мехоҳед супоред?',
      autosaved: 'Захира шуд',
      oneAttempt: 'Як кӯшиш',
      resume: 'Идома',
      errGeneric: 'Хато рух дод',
      errLogin: 'ID нодуруст ё вуруд нашуд',
      errNetwork: 'Пайвастшавӣ хато',
      errForbidden: 'Иҷозат нест',
      errExpired: 'Вақт тамом шуд',
      errAlreadySubmitted: 'Аллакай супорида шудааст',
      errNotAssigned: 'Шумо ба ин олимпиада таъин нашудаед',
      errLocked: 'Олимпиада қулфшуда аст',
      adminLogin: 'Воридшавии админ',
      adminPanel: 'Панели админ',
      tabStudents: 'Хонандагон',
      tabOlympiads: 'Олимпиадаҳо',
      tabResults: 'Натиҷаҳо',
      tabLeaderboard: 'Рейтинг',
      tabGmail: 'Gmail корбарон',
      tabContent: 'Контент',
      tabAdmins: 'Админҳо',
      create: 'Сохтан',
      edit: 'Таҳрир',
    ...
    ru: {
      ...
      leaderboardTitle: 'Рейтинг · Лучшие',
      ...
      quizAvailable: 'Викторина доступна',
      now: 'сейчас',
      ...
      studentLoginTitle: 'Вход ученика',
      studentLoginHint: 'Только по ID, выданному администратором',
      studentIdLabel: 'Ваш ID',
      studentIdPlaceholder: 'Номер ученика',
      studentLoginBtn: 'Войти',
      activeOlympiads: 'Активные олимпиады',
      quizzesSection: 'Викторины',
      noActiveOlympiad: 'Сейчас нет активных олимпиад.',
      noQuizzesStudent: 'Сейчас нет викторин.',
      statusActive: 'Активна',
      statusUpcoming: 'Скоро',
      statusFinished: 'Завершена',
      statusParticipated: 'Вы уже участвовали',
      ...
      next: 'Далее →',
      submit: 'Сдать',
      submitExam: 'Сдать работу',
      timeLeft: 'Осталось времени',
      questionOf: 'Вопрос {n} из {total}',
      questionXofY: 'Вопрос {n} / {total}',
      selectAnswer: 'Выберите ответ',
      writeAnswer: 'Напишите ответ',
      writeAnswerPlaceholder: 'Напишите ответ...',
      matchingHint: 'Сопоставьте пары',
      ...
      waiting: 'Ожидание',
      backToList: 'К списку',
      attemptUsed: 'Вы уже сдали эту олимпиаду',
      secondAttemptDenied: 'Вторая попытка не разрешена',
      timeUp: 'Время вышло',
      submitConfirm: 'Сдать работу?',
      autosaved: 'Сохранено',
      oneAttempt: 'Одна попытка',
      resume: 'Продолжить',
      errGeneric: 'Произошла ошибка',
      errLogin: 'Неверный ID или вход не выполнен',
      errNetwork: 'Ошибка сети',
      errForbidden: 'Нет доступа',
      errExpired: 'Время вышло',
      errAlreadySubmitted: 'Уже сдано',
      errNotAssigned: 'Вы не назначены на эту олимпиаду',
      errLocked: 'Олимпиада заблокирована',
      adminLogin: 'Вход администратора',
      adminPanel: 'Панель администратора',
      tabStudents: 'Ученики',
      tabOlympiads: 'Олимпиады',
      tabResults: 'Результаты',
      tabLeaderboard: 'Рейтинг',
      tabGmail: 'Gmail пользователи',
      tabContent: 'Контент',
      tabAdmins: 'Админы',
      create: 'Создать',
      edit: 'Изменить',
    ...
    en: {
      ...
      viewAll: 'View all →',
      leaderboard: 'Leaderboard · Top Rated',
      leaderboardTitle: 'Leaderboard · Top',
      activityEmpty: 'No activity yet',
      olympEmpty: 'None active',
      lbEmpty: 'Results after submissions',
      resultsLog: 'results.log',
      live: 'live',
      olympiadActive: 'Olympiad active',
      ...
      studentLoginHint: 'Only with an ID issued by the admin',
      studentIdLabel: 'Your ID',
      studentIdPlaceholder: 'Student number',
      studentLoginBtn: 'Sign in',
      activeOlympiads: 'Active olympiads',
      quizzesSection: 'Quizzes',
      noActiveOlympiad: 'No active olympiads right now.',
      noQuizzesStudent: 'No quizzes right now.',
      statusActive: 'Active',
      statusUpcoming: 'Upcoming',
      statusFinished: 'Finished',
      statusParticipated: 'You have already participated',
      ...
      attemptUsed: 'You have already submitted this olympiad',
      secondAttemptDenied: 'A second attempt is not allowed',
      timeUp: 'Time is up',
      ...
      errLogin: 'Invalid ID or login failed',
      errNetwork: 'Network error',
      errForbidden: 'Access denied',
      errExpired: 'Time expired',
      errAlreadySubmitted: 'Already submitted',
      errNotAssigned: 'You are not assigned to this olympiad',
      errLocked: 'Olympiad is locked',
      adminLogin: 'Admin login',
      adminPanel: 'Admin panel',
      tabStudents: 'Students',
      tabOlympiads: 'Olympiads',
      tabResults: 'Results',
      tabLeaderboard: 'Leaderboard',
      tabGmail: 'Gmail users',
      tabContent: 'Content',
      tabAdmins: 'Admins',
      create: 'Create',
      edit: 'Edit',
  ...
  function setLang(code) {
    ...
    try {
      window.dispatchEvent(new CustomEvent('geografia:lang', { detail: code }));
    } catch (e) {}
  }
